...
export const ConnectedCareNetwork: React.FC = () => {
    ...
    <div className="w-full space-y-8 py-6">
      <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-slate-150/70 dark:border-slate-800/80 p-6 rounded-2xl shadow-sm relative overflow-hidden">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {idx < steps.length - 1 && (
                  <div className="h-6 w-0.5 bg-slate-250 dark:bg-slate-800 md:hidden my-2" />
                )}
              </div>
            );
          })}
        ...
        <div className="mt-8 border-t border-slate-150 dark:border-slate-800/80 pt-5 min-h-[90px] flex items-center justify-center transition-all duration-300">
          {activeStep !== null ? (
            <div className="text-center space-y-2 max-w-2xl page-fade-in">
            ...
            <div className="text-center text-slate-400 dark:text-slate-500 italic text-sm flex flex-col items-center gap-1.5 float-subtle">
