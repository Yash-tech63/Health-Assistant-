...
import { Pill, Search, Building, CheckCircle, AlertTriangle } from 'lucide-react';
            ...
            <CardBody className="space-y-4">
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full text-xs rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-105 p-2.5 outline-none focus:ring-2 focus:ring-medical-500"
                >
              ...
              <div className="space-y-3 pt-2 border-t border-slate-50 dark:border-slate-800 max-h-72 overflow-y-auto">
                {filteredInventory.map(item => {
                  ...
                  return (
                    <div key={item.id} className="p-2 border border-slate-100 dark:border-slate-850 rounded-lg text-xs space-y-1 bg-slate-50/50 dark:bg-slate-900/30">
                      <div className="flex justify-between items-center gap-2">
                        ...
                        {isLow ? (
                          ...
                          <span className="text-[9px] font-bold text-hospital-600 dark:text-hospital-450 flex items-center gap-0.5">
                ...
                {filteredInventory.length === 0 && (
                  <p className="text-center text-xs text-slate-400 py-6">No medicine matching query found in inventory.</p>
                )}
              </div>
            </CardBody>
          </Card>
