          ...
          <CardBody className="space-y-4 text-center">
            {user?.avatar && user.avatar.startsWith('http') ? (
              <img 
                ...
                className="h-24 w-24 rounded-full object-cover border-2 border-emerald-500 shadow-md mx-auto"
              />
            ) : (
              <div className="text-4xl mx-auto bg-emerald-50 dark:bg-emerald-950/40 p-4 h-24 w-24 rounded-full flex items-center justify-center border border-emerald-200 dark:border-emerald-900 font-bold text-emerald-700 dark:text-emerald-300">
                👨‍🌾
              </div>
            )}
            <div>
