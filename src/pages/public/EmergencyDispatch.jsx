...
import { ShieldAlert, PhoneCall, CheckCircle2, ArrowRight } from 'lucide-react';
...
export const EmergencyDispatch = () => {
    ...
    return (<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 page-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Button variant="danger" size="lg" onClick={() => setIsModalOpen(true)} className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 font-extrabold text-sm sm:text-base py-3.5 px-6 shadow-xl shadow-red-600/20 border-none flex items-center justify-center gap-2 group">
                <span className="text-xl">🚑</span>
                <span>REQUEST AN AMBULANCE</span>
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform"/>
              </Button>

              <Button variant="outline" size="lg" onClick={handleScrollToHospitals} className="border-slate-700 text-slate-200 hover:bg-slate-800 hover:text-white font-bold text-sm sm:text-base py-3.5 px-6 flex items-center justify-center gap-2">
                <span className="text-xl">🏥</span>
      ...
      <EmergencyQuickActions onRequestAmbulance={() => setIsModalOpen(true)} onFindHospital={handleScrollToHospitals} onShareLocation={(loc) => setLocationStatus(loc)}/>

      {/* STEP 10, 11, 12, 13 — ACTIVE AMBULANCE REQUEST CONFIRMATION & TRACKER */}
      {activeRequest && (<section className="space-y-6 pt-4">
