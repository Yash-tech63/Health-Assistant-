...
import { Shield, Network, ClipboardList, CheckCircle2, ChevronRight, Activity } from 'lucide-react';
...
export const Landing = () => {
    ...
    return (<div className="space-y-20 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {workflowSteps.map((step, idx) => (<Card key={idx} className="relative hover:shadow-lg hover:-translate-y-1 transition-all border-t-4 border-t-medical-500">
