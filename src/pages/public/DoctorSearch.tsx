            ...
            <CardBody className="flex gap-4">
              {doc.avatar ? (
                <img 
                  ...
                  className="h-16 w-16 rounded-2xl object-cover border border-slate-200 dark:border-slate-800 shadow-xs shrink-0"
                />
              ) : (
                <div className="text-4xl bg-slate-50 dark:bg-slate-900 p-3 h-16 w-16 rounded-2xl flex items-center justify-center border border-slate-100 dark:border-slate-800 shrink-0">
                  👨‍⚕️
                </div>
              )}
                  ...
                  <div className="pt-2">
                    ...
                    <ul className="list-disc list-inside text-[11px] mt-0.5">
                      {doc.availability.map((av, idx) => (
                        <li key={idx} className="text-slate-600 dark:text-slate-400">{av}</li>
                      ))}
                    </ul>
                  </div>
                </div>
