...
import { Pill, AlertTriangle, RefreshCw, Plus, Search } from 'lucide-react';
...
export const Inventory: React.FC = () => {
  ...
  const hospitalInventory = inventory.filter(item => 
    item.facilityId === 'F-DIST-01' &&
  ...
  return (
    <div className="space-y-6">
      ...
      {lowStockMedicines.length > 0 && (
        <Alert type="warning" title="Critical Stock warning: Replenishment Required">
