...
import { ClipboardList, Plus, MapPin, Stethoscope, FileText, CheckCircle } from 'lucide-react';
...
export const ReferralsList: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!patient || !destFacility) return;
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {myOutboundReferrals.map(ref => (
            <Card key={ref.id} className="relative border-t-4 border-t-medical-500">
              <CardBody className="space-y-4 text-xs">
                ...
                {ref.notes && (
                  <p className="text-slate-500 leading-relaxed italic"><strong className="text-slate-700 dark:text-slate-400 not-italic">Clinical Transfer Note:</strong> "{ref.notes}"</p>
                )}
      ...
      {referModalOpen && (
        <Modal 
          ...
          title="Create Outbound Referral Transfer Slip"
          size="lg"
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="e.g. ECG showing ST depression; needs tertiary cath lab profiling and angiogram."
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Initial vitals, aspirin administered, patient stable for travel..."
                className="w-full text-xs rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-3 outline-none focus:ring-2 focus:ring-medical-500"
              />
            </div>
