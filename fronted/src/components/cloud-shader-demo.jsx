...
export const CloudShaderDemo = () => {
    return (<CloudShader speed={0.6} count={4} cloudColor="#ffffff" skyTopColor="#0f766e" skyBottomColor="#e0f2fe" className="w-full min-h-screen flex items-center justify-center">
