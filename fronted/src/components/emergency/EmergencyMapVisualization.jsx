...
export const EmergencyMapVisualization = ({ patientLocation = 'Dhami Village, Sector 4', ambulanceEta = '10 min', distance = '2.8 km', className = '', }) => {
    return (<div className={`relative w-full h-64 sm:h-72 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-900 shadow-md ${className}`}>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none z-10">
        ...
        {/* Outer glow path */}
        <path d="M 60,190 C 130,120 220,210 320,130 C 400,75 480,140 560,90" fill="none" stroke="rgba(239, 68, 68, 0.25)" strokeWidth="8" strokeLinecap="round"/>

        {/* Animated Dashed Main Route */}
        <path d="M 60,190 C 130,120 220,210 320,130 C 400,75 480,140 560,90" fill="none" stroke="url(#routeGradient)" strokeWidth="3.5" strokeDasharray="6 6" strokeLinecap="round" className="animate-pulse"/>

        {/* Pulse Moving Dot along Route */}
        <circle r="5" fill="#f59e0b">
          <animateMotion dur="4s" repeatCount="indefinite" path="M 60,190 C 130,120 220,210 320,130 C 400,75 480,140 560,90"/>
        </circle>
      </svg>
