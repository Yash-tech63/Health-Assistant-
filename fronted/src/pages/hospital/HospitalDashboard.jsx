              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs text-left">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-850">
                    {pendingInbound.map(ref => (<tr key={ref.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
          ...
          <Card>
            <CardBody className="p-0">
              <div className="divide-y divide-slate-100 dark:divide-slate-850">
                {activeInpatients.map(inpat => (<div key={inpat.id} className="p-3 text-xs flex justify-between items-center hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
                    <div>
                ...
                {activeInpatients.length === 0 && (<div className="p-6 text-center text-xs text-slate-450">No patients currently admitted under referral guidelines.</div>)}
              </div>
            </CardBody>
          </Card>
        </div>
