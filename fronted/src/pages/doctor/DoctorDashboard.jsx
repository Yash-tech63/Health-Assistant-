...
import { FileText, ClipboardList, TrendingUp, Calendar, AlertTriangle } from 'lucide-react';
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs text-left">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-850">
                    {myAppointments.map(a => (<tr key={a.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
                        ...
                        <td className="px-4 py-3.5 text-right">
                          <Button variant="primary" size="sm" onClick={() => navigate('/portal/doctor/patients')}>
                            Diagnose
                          </Button>
                        </td>
                      </tr>))}

                    {myAppointments.length === 0 && (<tr>
        ...
        <div className="space-y-4 col-span-1">
          ...
          <Card>
            <CardBody className="space-y-4">
              ...
              <Button variant="outline" className="w-full justify-between" onClick={() => navigate('/portal/doctor/referrals')}>
